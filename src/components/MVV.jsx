...
const MVV = ({position}) => {
  return (
        <div className={`min-h-[50vh] lg:max-w-[80vw] w-full mx-auto z-10 lg:left-10 lg:-bottom-52 flex flex-wrap lg:flex-nowrap lg:items-start item-center justify-center pt-14 bg-white px-8  relatve text-center ease-in-out duration-200`}>
