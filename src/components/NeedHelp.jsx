  ...
  return (
    <div className='flex flex-col md:flex-row items-center justify-between px-32 my-20'>
        <div className="flex flex-col items-center justify-evenly relative lg:basis-1/2">
            ...
            <p className="italic text-gray-400 z-10">Send us an email of what you wish to talk to us about. We are always opened to our customers and willing to serve them to excellence.</p>
        </div>
        <div className="relative flex lg:basis-1/2 items-center justify-evenly">
            ...
            <Link target='_blank' href="to:info@jasaka.com" className='text-4xl font-extrabold text-black'>info@jasaka.com</Link>
        </div>
    </div>
  )
}
